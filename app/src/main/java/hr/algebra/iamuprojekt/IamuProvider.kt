...
val IAMU_PROVIDER_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/$PATH")
...
class IamuProvider : ContentProvider() {
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        return ContentUris.withAppendedId(IAMU_PROVIDER_CONTENT_URI, id)
    }
